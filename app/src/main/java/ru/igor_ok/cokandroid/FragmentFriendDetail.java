...
public class FragmentFriendDetail extends Fragment {
    ...
    private OnFriendDetailListener mListener;

    public static FragmentFriendDetail newInstance(String _userId) {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        uSql = new FriendSqlHelper(getActivity());

        UserModel.UserItem ui = uSql.getOne(userId);
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mListener = (OnFriendDetailListener) activity;
    ...
    public interface OnFriendDetailListener {
